...
import { checkFolderIsEmpty,  downloadEmailAttachement, imageToBase64,
    sleep, highlightLinks, waitForEvent, readPromptFromFile} from './puppeteer_automation_helper.js';
...
export async function main_login(userInput){
    ...
    const main_prompt = await readPromptFromFile('./src/components/puppeteer/prompts/openai_prompt.txt');
    // Format Prompt 
    const messages = [
        {
            "role": "system",
