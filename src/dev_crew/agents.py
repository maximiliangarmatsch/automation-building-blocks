...
class Agents:
    ...
    def backend_developer(self) -> Agent:
        return Agent(
            ...
            backstory="With a lot of backend development experience, you're proficient in languages like Python and Node.js, and have extensive knowledge of database systems and cloud platforms. You've successfully built and maintained high-traffic web applications and are well-versed in microservices architecture.",
            allow_delegation=False,
            verbose=True,
            allow_code_execution=True,
            tools=[FileWriteTool()],
