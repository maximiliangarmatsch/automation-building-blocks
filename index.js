...
// Import module
import {main_login} from "./utils/login_main_function.js"
import {main_response} from "./utils/main_function_response_generation.js"
...
client.on('messageCreate', async (message) => {
    ...
    try {
      ...
      // Check user message strat with !logout
        ...
        if (login_status){
          [result, page, login_status, browser] = await main_response(message.content+ " Action:email", page, browser);
        }
        else{
          [result, page, login_status, browser] = await main_login(message.content+ " Action:email");  
      }
